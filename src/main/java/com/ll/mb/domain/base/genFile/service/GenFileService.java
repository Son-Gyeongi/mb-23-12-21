package com.ll.mb.domain.base.genFile.service;

import com.ll.mb.domain.base.genFile.entity.GenFile;
import com.ll.mb.domain.base.genFile.repository.GenFileRepository;
...
public class GenFileService {
    ...
    public GenFile save(String relTypeCode, long relId, String typeCode, String type2Code, long fileNo, String sourceFile) {
        ...
        // fileNo 가 0 이면, 이 파일은 로직상 무조건 새 파일이다. // 기존 이미지 삭제 후 넣는다.
